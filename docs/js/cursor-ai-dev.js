(() => {
  ...
  const MODULES = [
    { id: "module-1", href: "module-1.html", num: "1", label: "Reality Check", meta: "Day 1" },
    { id: "module-2", href: "module-2.html", num: "2", label: "Grill + Spec", meta: "Day 2" },
    { id: "module-3", href: "module-3.html", num: "3", label: "Tickets + Implement", meta: "Day 3" },
    { id: "module-4", href: "module-4.html", num: "4", label: "Debug / Review", meta: "Day 4" },
    { id: "module-5", href: "module-5.html", num: "5", label: "Full Workflow", meta: "Day 5" },
  ];
  ...
  function bindCopyButtons() {
    document.querySelectorAll("[data-copy-target]").forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        const text = el?.textContent || el?.innerText || CHAIN_TEMPLATE;
    ...
    document.querySelectorAll("[data-copy-template]").forEach((btn) => {
      btn.addEventListener("click", () => {
        const feedback = btn.parentElement?.querySelector(".copy-feedback");
        copyText(CHAIN_TEMPLATE, feedback);
      });
    });
  }
